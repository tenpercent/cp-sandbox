...
C group (Local variables)
      ...
      Integer iPt(3)
      Real*8  v1, v2, vv, c1, angle2Faces, mutualOrientation

      Logical flagBNDs, flagFACE, flagEDGE
      Logical flagTM, check33, check13, l1, l2
...
c     v1 = calVol(XYP(1, iP1), XYP(1, iP2), XYP(1, iP3), XYP(1, iPa))
c     v2 = calVol(XYP(1, iP1), XYP(1, iP2),  XYP(1, iP3), XYP(1, iPb))
c
c     If(v1 * v2.GE.0D0) Goto 1000

      vv = mutualOrientation(XYP(1, iP1), XYP(1, iP2), XYP(1, iP3), 
     &                       XYP(1, iPa), XYP(1, iPb))

      If(vv.GE.0D0) Goto 1000
