...
C ================================================================
      ...
      integer L, ip, ptr, i, j, k, new, NEWQT, dir(2)
...
C ================================================================
      ...
      double precision sqrd(8, MaxH), SQRDST, sqdist, min
...
C ================================================================
      ...
      integer i, j, k, n, idx, ip, NEARST, MaxTrials
      logical ENCLOSE
...
C ================================================================
C (Local variables)
      integer          i, j, idx, irel, ip(4), BASETET
      double precision a, b, c, d, det, PREC1
      double precision calVol
...
C ================================================================
      ...
      integer          Face(3,4)
      double precision frac, calVol, Vlm
      integer i
