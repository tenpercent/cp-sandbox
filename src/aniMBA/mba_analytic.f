...
C  The function returns 0 (scalar tensor) or 1 (full tensor).  The 
C  scalar tensor requires to define only M11.
C
C
C
...
c ... original structure of the data
 ...
 5001 Format('MBA: STONE FLOWER! (1997-2010), version 2.3', /,
