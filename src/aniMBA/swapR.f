...
C group (Local variables)
      ...
      Real*8  XYPs(3), XYPd(3), c1, angle2Faces
      Real*8  calVol, oldVolume, newVolume, vEs(MaxS)
      Real*8  vv, mutualOrientation

      Logical flagBNDs, flagLOOP, flagSHUT, flagFACE, flagEDGE
      Logical check33, check13, l1, l2
...
c           v1 = calVol(XYP(1, iPa), XYP(1, iP1), XYP(1, iP2), XYPs)
c           v2 = calVol(XYP(1, iPa), XYP(1, iP1), XYP(1, iP2), XYPd)
c
c           If(v1 * v2.LE.0D0) Goto 400
c
c           v1 = calVol(XYP(1, iPb), XYP(1, iP1), XYP(1, iP2), XYPs)
c           v2 = calVol(XYP(1, iPb), XYP(1, iP1), XYP(1, iP2), XYPd)
c
c           If(v1 * v2.LE.0D0) Goto 400

            vv = mutualOrientation(XYP(1, iPa), XYP(1, iP1), 
     &                             XYP(1, iP2), XYPs, XYPd)

            If(vv.LE.0D0) Goto 400

            vv = mutualOrientation(XYP(1, iPb), XYP(1, iP1), 
     &                             XYP(1, iP2), XYPs, XYPd)
