...
C group (Local variables)
      ...
      Real*8  domainVolume, surfaceArea, ver, dvo, sao
      Real*8  fixedVolume,  fixedArea,   aer, fvo, fao  
      Real*8  s, sa, rR
      Real*8  avgQ, aQuality

      Logical flagUAR, flagFBE, flagTM, probeAny
...
c ... check for termination signals (dummy function for simulators)   
     ...
     &            mF2E, mE2F, mSWAP, mINSRT, mDELET, mMOVE, mCLPS
      ...
      If(rQuality.GT.Quality) Then
         ...
         Goto 100
      End if
      rQuality = rQuality * QualityFactor
...
c FIXME fixed volume check is disabled by Danilov
c         If(ver.GT.volPREC .OR. aer.GT.volPREC) Call errMes(5201, 
c     &        'ani2', 'fixed volume or/and surface is not preserved')
...
c ... display output
 5000 Format('ITRs:', I7, ' Q=', E10.4, '  #V#F#T:', I7,I8,I9,
     &       '  tm=', F6.1, 's')
